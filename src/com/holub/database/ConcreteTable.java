...
/* package */ class ConcreteTable implements Table {
	 ...
	 */
	public ConcreteTable(Table.Importer importer) throws IOException, InterruptedException {
		importer.startTable();
...
//				/* Failed correctly, do nothing */ }
		...
		public void testStore() throws IOException, ClassNotFoundException, InterruptedException { // Flush the table to disk, then reread it.
