...
public class TableFactory
{
	...
	public static Table create( Table.Importer importer )
			throws IOException, InterruptedException {	return new ConcreteTable( importer );
	}
	 ...
	 */
	public static Table load( String name ) throws IOException, InterruptedException {	return load( name, new File(".") );
	}
	...
	public static Table load( String name, String location )
			throws IOException, InterruptedException {	return load( name, new File(location) );
	}
